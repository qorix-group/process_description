...
Apply the fault model to the diagram and document the results in the template. Use the content of the document `Feature FMEA Template <https://eclipse-score.github.io/module_template/main/features/feature_example/safety_analysis/fmea.html>`__, `Component FMEA Template <https://eclipse-score.github.io/module_template/main/components/component_example/safety_analysis/fmea.html>`__
...
Use the content of the document `Feature DFA Template <https://eclipse-score.github.io/module_template/main/features/feature_example/safety_analysis/dfa.html>`__, `Component DFA Template <https://eclipse-score.github.io/module_template/main/components/component_example/safety_analysis/dfa.html>`__ to describe e.g. why
