...
#. Consult which programming languages, design/coding guidelines and tools are used for Software
   development within the project specific :need:`SW development Plan <wp__sw_development_plan>`.
...
#. Implement the source code, by using the coding guidelines within the project specific :need:`SW development Plan <wp__sw_development_plan>`. for the programming languages in your project.
