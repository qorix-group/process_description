...
#. Consult which programming languages, design/coding guidelines and tools are used for Software
   development within the project specific :need:`Project Management Plan <wp__project_mgt>`
...
#. Implement the source code, by using the coding guidelines within the project specific :need:`Project Management Plan <wp__project_mgt>` for the programming languages in your project.
