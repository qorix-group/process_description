...
.. needpie:: Audit Status - Support
   ...
   type == 'std_req' and "__support" in id and 'open' in tags
   type == 'std_req' and "__support" in id and 'ok' in tags
   type == 'std_req' and "__support" in id and 'recommendation' in tags
