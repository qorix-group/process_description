...
.. list-table:: Architecture Design Review Checklist
    ...
    * - ARC_01_01
      ...
      - automated
      - Trace should be checked by Sphinx. Will be removed from checklist once the requirement (:need:`Correlations of the architectural building blocks <gd_req__arch_build_blocks_corr>`) is implemented. See `Tool Requirements <https://eclipse-score.github.io/docs-as-code/main/internals/requirements/requirements.html>`_.
      -
      -
      -
    * - ARC_01_02
