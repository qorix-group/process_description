...
.. workflow:: Create/Maintain Module Release Note
   ...
   The module release note is created for each release by the module project lead. It may be updated
...
.. workflow:: Create/Maintain Platform Release Note
   ...
   The platform release note is created for each release by the project lead circle. It may be updated
   later in case of bugs found after the release is published.
